...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Poupi — controle financeiro simples" },
      {
        name: "description",
        content:
          "Organize contas, cartões, faturas parceladas e pagamentos em um só lugar, com uma visão clara do seu dinheiro.",
      },
      { name: "author", content: "Poupi" },
      { property: "og:title", content: "Poupi — controle financeiro simples" },
      {
